...
$contenu .= '<th class="header__item">Modifier</th>';
$contenu .= '</tr>';
...
$contenu .= '<div class="table-content">';
    while ($ligne = $resultat->fetch_assoc())
    {
        ...
        $contenu .='
            <td><a class="footer-social-icon" 
            href="?action=modification_reservation&id_reservation=' . $ligne['id_reservation'] . '">
            <svg  width="30" height="30" fill="green" class="bi bi-pencil-fill" viewBox="0 0 16 16">
