...
<!-- Navigation gauche -->
        ...
        <nav class="footer-navigation">
            ...
            <ul>
                ...
                <li>
                    <a class="footer-navigation-link" href="<?php echo RACINE_SITE; ?>index.php?action=affichage_Nous_Trouver">
                        Nous trouver
                    </a>
                </li>
                <li>
                    <a class="footer-navigation-link" href="<?php echo RACINE_SITE; ?>contact.php">
                        Nous contacter
                    </a>
                </li>
            ...
            <ul>
                ...
                <li>
                    <a class="footer-social-icon" href="https://twitter.com/chatillon92320">
                    ...
                    <a class="footer-social-icon" href="https://www.facebook.com/laludothequedechatillon">
                        <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="footer-social-icon" href="https://www.instagram.com/laludothequedechatillon/?hl=fr">
                        <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!-- sites partenaires -->
        ...
        <div class="footer-patterns">
            ...
            <a class="footer-social-icon" href="https://ville-chatillon.fr/"> 
                <img style="max-height:70px; width:auto" src="<?php echo RACINE_SITE; ?>./inc/img/logo_chatillon.png">
                <span class="sr-only">Ville de Chatillon</span>
            </a>
            <a class="footer-social-icon" href="https://guynemer92.fr/"> 
                <img style="max-height:70px; width:auto" src="<?php echo RACINE_SITE; ?>./inc/img/logo_guynemer2.png">
                <span class="sr-only">Guynemer</span>
            </a>  
            <a class="footer-social-icon" href="https://ville-chatillon.fr/"> 
                <img style="max-height:70px; width:auto" src="<?php echo RACINE_SITE; ?>./inc/img/logo_theatre.png">
                <span class="sr-only">Cinema de Chatillon</span>
            </a>
            <a class="footer-social-icon" href="https://ville-chatillon.fr/"> 
                <img style="max-height:70px; width:auto" src="<?php echo RACINE_SITE; ?>./inc/img/logo_omeps.png">
                <span class="sr-only">OMEPS</span>
            </a>   
